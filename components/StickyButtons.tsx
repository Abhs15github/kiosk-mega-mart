...
export default function StickyButtons() {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 flex flex-col gap-3 md:hidden">
      ...
      >
        {/* WhatsApp SVG Icon */}
        <svg className="w-7 h-7 xs:w-8 xs:h-8 text-white fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="w-14 h-14 xs:w-16 xs:h-16 bg-gradient-to-br from-purple-500 via-pink-500 to-orange-500 hover:from-purple-600 hover:via-pink-600 hover:to-orange-600 rounded-full shadow-2xl hover:shadow-3xl flex items-center justify-center transition-all duration-300 transform hover:scale-110 active:scale-95 group"
